...
const svgProps = { width: 28, height: 28, fill: 'none', stroke: 'currentColor', strokeWidth: 1.8, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const, viewBox: '0 0 24 24' };
...
// --- Platform Icons ---
const platformSvgProps = { width: 18, height: 18, fill: 'currentColor', viewBox: '0 0 24 24' };

export function IconTelegram() {
  return (
    <svg {...platformSvgProps}>
