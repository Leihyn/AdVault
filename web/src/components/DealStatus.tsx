...
const STATUS_CONFIG: Record<string, { label: string; mode: 'elevated' | 'mono' | 'outline'; color?: string; bg?: string }> = {
  ...
  POSTED:    { label: 'Posted', mode: 'mono', color: '#007AFF', bg: 'rgba(0, 122, 255, 0.1)' },
  TRACKING:  { label: 'Tracking', mode: 'mono', color: '#5856D6', bg: 'rgba(88, 86, 214, 0.1)' },
  ...
  FAILED:    { label: 'Failed', mode: 'outline', color: '#FF3B30', bg: 'rgba(255, 59, 48, 0.1)' },
